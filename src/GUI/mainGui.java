...
public class mainGui extends JFrame {
	...
	Algo2 algo2;
	private static double windRatio; 	//wspó³czynnik poziomy i pionowy wiatru
	String xDir;
	String yDir;
	String windPow;
	static double thickness=2;
	 double [][] temp = new double[700][570];
	private static double[][] table2 = new double[700][570];
	static byte[][] table;
	private Algo a;
	 ...
	 */
	 ...
	 private void startButtonActionPerformed(ActionEvent evt) {  
		 setWind(new Wind(Double.parseDouble(wspXTextField.getText()), Double.parseDouble(wspYTextField.getText()), Integer.parseInt(powerTextField.getText())));
		 a = new Algo();
